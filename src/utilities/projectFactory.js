...
export const createProject = async (directoryCid, goalAmountInWei, userAddress) => {
    try {
        // Log the provided inputs
        console.log("Creating project with inputs:", { directoryCid, goalAmountInWei, userAddress });

        // Estimate gas for the transaction
        const gasEstimate = await projectFactory.methods
            .createProject(directoryCid, goalAmountInWei)
